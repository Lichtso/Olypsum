...
my($version) = "0.4.2";
my(@libs) = qw(/usr/lib/libc++.so.1 /usr/lib/x86_64-linux-gnu/libopenal.so.1 /usr/lib/libv8.so /usr/lib/Leap/libLeap.so /usr/local/lib/libSDL2-2.0.so.0 /usr/local/lib/libSDL2_ttf-2.0.so.0 /usr/local/lib/libSDL2_image-2.0.so.0 /usr/local/lib/libBulletCollision.so /usr/local/lib/libBulletDynamics.so /usr/local/lib/libBulletSoftBody.so /usr/local/lib/libBulletMultiThreaded.so /usr/local/lib/libLinearMath.so);
