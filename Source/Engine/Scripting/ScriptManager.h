...
class ScriptManager {
    ...
    static v8::Handle<v8::Value> ScriptIsKeyPressed(const v8::Arguments& args);
    ...
    static v8::Handle<v8::Value> ScriptGetMouseMotionX(v8::Local<v8::String> property, const v8::AccessorInfo& info);
    static v8::Handle<v8::Value> ScriptGetMouseMotionY(v8::Local<v8::String> property, const v8::AccessorInfo& info);
    public:
