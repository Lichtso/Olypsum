...
class ScriptBaseObject : public ScriptBaseClass {
    ...
    ScriptDeclareMethod(GetTransformUpLink);
    ScriptDeclareMethod(GetBoneUpLink);
    ScriptDeclareMethod(IterateLinks);
    static void GetLinkCount(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& args);
    protected:
...
class ScriptPhysicObject : public ScriptBaseObject {
    ...
    ScriptDeclareMethod(GetCollisionShapeInfo);
    protected:
