...
class BoundingVolume {
    ...
    BoundingVolume() : transformation(NULL) {};
    BoundingVolume(Matrix4* trans) : transformation(trans) {};
};
...
class Bs3 : public BoundingVolume {
    ...
    void drawWireFrame(Vector3 color, unsigned char accuracyX, unsigned char accuracyY);
    bool testPointHit(Vector3 pos);
