...
vec2 vec2SeedRand(inout int seed, vec2 max) {
    return vec2(vec1SeedRand(seed, max.x), vec1SeedRand(seed, max.y));
}

vec3 vec3SeedRand(inout int seed, vec3 max) {
    return vec3(vec1SeedRand(seed, max.x), vec1SeedRand(seed, max.y), vec1SeedRand(seed, max.z));
}

float vec1Vec2Rand(vec2 co) {
